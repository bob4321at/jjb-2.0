...
func initPlayer() {
	players = map[string]Player{
		...
		"gojo":    newPlayer(current_level.player_spawn, *newAnimatedTexture("./art/players/gojo.png"), newTexture("./art/domains/simple_domain.png"), func(l *Level) { player.simpleDomain(current_level) }, gojo_attacks),
		"megumi":  newPlayer(current_level.player_spawn, *newAnimatedTexture("./art/players/megumi.png"), newTexture("./art/domains/simple_domain.png"), func(l *Level) { player.simpleDomain(current_level) }, megumi_attacks),
