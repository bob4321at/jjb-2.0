...
func InitPlayer(spawn_point utils.Vec2) {
	Players = map[string]Player{
		...
		"tk": newPlayer(spawn_point, *textures.NewAnimatedTexture("./art/players/tk.png"), textures.NewTexture("./art/domains/simple_domain.png", ""), func(enemies []*enemyai.Enemy) { Player_Ref.simpleDomain(enemyai.Enemies_In_World) }, tk_attacks),
	}
}
